        ...
        {{-- <nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
            <a href="#"
                ...
                <div class="w-6 h-6 flex shrink-0">
                    <img src="{{ asset('dummy-icon.png') }}" alt="icon" />
                </div>
                <span>Tech</span>
            </a>
            <a href="#"
                ...
                <a href="#" class="card-authors">
                    <div
                        ...
                        <div class="w-[70px] h-[70px] flex shrink-0 rounded-full overflow-hidden">
                            <img src="{{ asset('dummy-avatar.png') }}" class="object-cover w-full h-full"
                                alt="avatar" />
                        </div>
                        <div class="flex flex-col gap-1 text-center">
                            <p class="font-semibold">John Doe</p>
                            <p class="text-sm leading-[21px] text-[#A3A6AE]">3 articles</p>
                        </div>
                    </div>
                </a>
                <!-- Repeat for more authors if necessary -->
            </div>
        </section> --}}
            ...
            <div class="flex flex-col gap-3 shrink-0 w-fit">
                <a href="#">
                    <div class="w-[900px] h-[120px] flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden">
                        <img src="{{ asset('dummy-ads.jpg') }}" class="object-cover w-full h-full" alt="ads" />
                    </div>
                </a>
        ...
        {{-- <section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
            ...
            <div class="flex justify-between items-center h-fit">
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <img src="{{ asset('dummy-thumbnail.jpg') }}" class="thumbnail absolute w-full h-full object-cover"
                        alt="icon" />
                    <div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10">
                    </div>
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="#"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">The
                                Impact of Movies on Society</a>
                            <p class="text-white">Sep 25, 2024</p>
                        </div>
                    </div>
                </div>
                        ...
                        <a href="#" class="card py-[2px]">
                            <div
                                ...
                                <div class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
                                    <img src="{{ asset('dummy-thumbnail.jpg') }}" class="object-cover w-full h-full"
                                        alt="thumbnail" />
                                </div>
                                <div class="flex flex-col justify-center-center gap-[6px]">
                                    <h3 class="font-bold text-lg leading-[27px]">Short Article Title</h3>
                                    <p class="text-sm leading-[21px] text-[#A3A6AE]">Sep 25, 2024</p>
                                </div>
                            </div>
                        </a>
                ...
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="#"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">Top
                                10 Startup Strategies</a>
                            <p class="text-white">Sep 25, 2024</p>
                        </div>
                    </div>
                </div>
